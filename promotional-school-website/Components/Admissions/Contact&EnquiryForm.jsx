...
function ContactandEnquiryForm() {
    ...
    return (
        <div className="p-5" style={{ backgroundColor: "rgba(217, 218, 238, 0.39) " }}>
            <div className="text-center">
                ...
                <h3 className="fw-bold" style={{ color: "rgb(20, 30, 60)" }}>Contact & Admission Enquiry
                    <hr style={{ borderColor: "rgb(10, 10, 10)", opacity: 0.9, width: "390px", margin: "7px auto" }} />
                </h3>
            </div>

            <div className="d-flex flex-wrap gap-5 pt-4 justify-content-center align-items-center">
                ...
                <div style={{ maxWidth: "320px" }}>
                    ...
                    <div
                        ...
                        style={{ width: "100%", height: "220px", backgroundColor: "rgb(247, 238, 220)" }}
                    >
                        <iframe
                ...
                <form
                    ...
                    noValidate
                    className="text-start rounded-4 p-4 shadow-lg ms-5 "
                    style={{ maxWidth: "700px", width: "500px", backgroundColor:"rgba(220, 221, 243, 0.81)" }}
                >
                    ...
                    {submitted && (
                        <div className="text-success fw-bold pt-3 ps-5">
