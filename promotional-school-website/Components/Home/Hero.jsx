...
function Hero() {
    return (
        <>
            ...
            <div className="w-100 h-100" style={{ backgroundColor: "rgb(240, 235, 225)" }}>
                <table>
                    <tr>
                        <th className=" w-50 h-100">
                            ...
                            <div className="ms-5"> 
                                ...
                                <i class="fa-solid fa-circle"></i>Admissions Open for 2026-27
                            </button>
                            ...
                            <div className="mt-5 ms-5">
                                <button className="btn btn-dark border-dark fw-bold rounded-5 px-2 py-2 ms-5 me-5 mb-5 ms-auto p-3 d-inline-flex align-items-center" style={{ backgroundColor: "rgb(227, 162, 60)", color: "rgb(25, 31, 49)" }}>
                                    Apply for Admission
                                </button>

                                <button className="btn btn-dark border-dark fw-bold rounded-5 px-2 py-2 ms-5 mb-5 ms-auto p-3 d-inline-flex align-items-center" style={{ backgroundColor: "rgb(250, 246, 236)", color: "rgb(25, 31, 49)" }}>
                                    Explore our School
                                </button>
                            </div>
