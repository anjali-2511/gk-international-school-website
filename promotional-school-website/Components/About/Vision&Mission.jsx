function VisionAndMission() {
    return(
        ...
        <div className="text-center p-5" style={{ backgroundColor: "rgb(206, 207, 223)" }}>
            ...
            <h3 className="fw-bold" style={{ color: "rgb(20, 30, 60)" }}>Our Vision & Mission
                <hr style={{ borderColor: "rgb(10, 10, 10)", opacity: 0.9, width: "280px", margin: "7px auto" }} />
            </h3>

            <div className="d-flex flex-wrap gap-5 justify-content-center pt-4">
                <div
                    className="text-start rounded-4 p-4 shadow-sm bg-white"
                    style={{ width: "400px", borderTop: "3px solid rgb(231, 159, 43)" }}
                >
                    <div
                ...
                <div
                    className="text-start rounded-4 p-4 shadow-sm bg-white"
                    style={{ width: "400px", borderTop: "3px solid rgb(58, 121, 88)" }}
                >
                    <div
                        className="d-flex align-items-center justify-content-center rounded-3 mb-3"
